...
async function main() {
  try {
    ...
    figma.notify('✅ LiberStudy 线框图生成完成！', { timeout: 4000 });

  } catch (error) {
    console.error('❌ 生成失败:', error.message, error.stack);
    figma.notify('❌ 失败：' + error.message, { error: true });
  }
