...
def _load_system_prompt(has_ppt: bool) -> str:
    ...
    if has_ppt:
        return (
            ...
            "(with timestamps), generate AI notes in markdown. "
            "Adjust the depth of each bullet based on how much emphasis the teacher placed on it.\n\n"
            "Output format (strictly follow):\n"
            "## 第{N}页\n"
            "- [MM:SS–MM:SS] key point from this page\n"
            "- [MM:SS–MM:SS] another key point\n\n"
            "Importance grading rules:\n"
            "- HIGH importance (teacher spent significant time AND gave examples, analogies, or repeated emphasis): "
            "write a bullet with 1-2 sentences of explanation after the timestamp.\n"
            "- LOW importance (teacher briefly mentioned it): write a short bullet, one phrase only.\n"
            "- NOT covered (teacher did not mention it): skip entirely.\n\n"
            "Signals for HIGH: long transcript coverage, explicit examples, analogies, repetition.\n"
            "Signals for LOW: teacher just read the bullet aloud or mentioned it in passing.\n\n"
            "Other rules:\n"
        ...
        return (
            ...
            "generate AI notes organized by topic in markdown. "
            "Adjust the depth of each bullet based on how much emphasis the teacher placed on it.\n\n"
            "Output format (strictly follow):\n"
            "## Topic Name\n"
